...
class AllpayConfigModel(BasicModel):
    ...
    merchant_id = Fields.StringProperty(default=u'', verbose_name=u'Merchant ID', tab_page=0)
    hash_key = Fields.StringProperty(default=u'', verbose_name=u'Hash KEY', tab_page=0)
    hash_iv = Fields.StringProperty(default=u'', verbose_name=u'Hash IV', tab_page=0)
